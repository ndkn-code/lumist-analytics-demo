...
const STORAGE_KEY = 'lumist-social-account-facebook';

// Facebook sub-tab configuration
const FACEBOOK_TABS = [
    {
        id: 'overview',
        label: 'Overview',
        path: '/social-media/facebook/overview',
        icon: LayoutGrid,
        available: true
    },
    {
        id: 'audience',
        label: 'Audience',
        path: '/social-media/facebook/audience',
        icon: Users,
        available: true
    },
    {
        ...
        path: '/social-media/facebook/content',
        icon: FileText,
        available: true
    },
    {
    ...
    },
    {
        ...
        path: '/social-media/facebook/trends',
        icon: TrendingUp,
        available: false
    }
];
...
const FacebookLayout = () => {
    ...
    useEffect(() => {
        const loadAccounts = async () => {
            ...
            try {
                const platformAccounts = await getAccountsForPlatform('facebook');
                ...
                console.error('Error loading Facebook accounts:', err);
            } finally {
    ...
    // Redirect to overview if at /social-media/facebook root
    if (location.pathname === '/social-media/facebook' || location.pathname === '/social-media/facebook/') {
        return <Navigate to="/social-media/facebook/overview" replace />;
    }

    // Determine active tab
    const activeTab = FACEBOOK_TABS.find(t => location.pathname === t.path);
